 ...
 * @author dosen
 */
public final class DlgCariObatDefaultFRJ extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariObatDefaultFRJ(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-11-2020" }));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariObatDefaultFRJ dialog = new DlgCariObatDefaultFRJ(new javax.swing.JFrame(), true);
    ...
    public void isCek(){   
        bangsal=Sequel.cariIsi("select kd_bangsal from set_depo_ralan where kd_poli=? and kd_bangsal = 'FRJ'",Sequel.cariIsi("select kd_poli from reg_periksa where no_rawat=?",TNoRw.getText()));
        if(bangsal.equals("")){
