 ...
 * @author perpustakaan
 */
public final class DlgPembayaranRalanObatRsud extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPembayaranRalanObatRsud(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] rowRwJlDr={"Tanggal","No.Nota","Nama Pasien","Poli/Unit","Perujuk",
                            "Obat+Emb+Tsl","Tambahan","Potongan",
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPembayaranRalanObatRsud dialog = new DlgPembayaranRalanObatRsud(new javax.swing.JFrame(), true);
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[] {
                        ...
                        Valid.SetAngka(Obat+Ralan_Dokter+Tambahan+Potongan),
                ...
                tabMode.addRow(new Object[] {
                        ...
                        Valid.SetAngka(ttlObat+ttlTambahan+ttlPotongan),"",""
                });
            } catch (Exception e) {
