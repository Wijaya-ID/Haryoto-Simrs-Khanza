 ...
 * @author perpustakaan
 */
public final class DlgPembayaranRalanPoliRsud extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPembayaranRalanPoliRsud(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPembayaranRalanPoliRsud dialog = new DlgPembayaranRalanPoliRsud(new javax.swing.JFrame(), true);
        ...
        try{      
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    all=all+Ralan_Dokter+Ralan_Dokter_paramedis+Ralan_Paramedis+Tambahan+Potongan+Registrasi;

                    if((Ralan_Dokter+Ralan_Paramedis+Ralan_Dokter_paramedis+Tambahan+Potongan+Registrasi)>0){
                    ...
                    tabMode.addRow(new Object[] {
                        ...
                        Valid.SetAngka(Ralan_Dokter+Ralan_Paramedis+Ralan_Dokter_paramedis+Tambahan+Potongan+Registrasi),
