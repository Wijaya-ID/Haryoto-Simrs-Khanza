...
public class DlgCariPeriksaLab extends javax.swing.JDialog {
    ...
    private String diagnosa="",saran="",kesan="",idpa="",diagpa="",mikros="",makros="",kesimp="",
    ...
    private void initComponents() {
        ...
        MnInputHasilLabPA = new javax.swing.JMenuItem();
        ...
        Diagpa = new widget.TextBox();
        label12 = new widget.Label();
        Idpa = new widget.TextBox();
        panelGlass7 = new widget.panelisi();
        BtnSimpan1 = new widget.Button();
        BtnCloseIn6 = new widget.Button();
        jPanel4 = new javax.swing.JPanel();
        Scroll7 = new widget.ScrollPane();
        makroskopik = new widget.TextArea();
        Scroll8 = new widget.ScrollPane();
        mikroskopik = new widget.TextArea();
        ...
        MnCetakHasilLab9.setText("Hasil Lab PA");
        MnCetakHasilLab9.setToolTipText("");
        ...
        MnCetakHasilLab20.setText("Hasil Lab PA");
        ...
        MnInputHasilLabPA.setBackground(new java.awt.Color(255, 255, 254));
        MnInputHasilLabPA.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnInputHasilLabPA.setForeground(new java.awt.Color(50, 50, 50));
        MnInputHasilLabPA.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnInputHasilLabPA.setText("Input Hasil Lab PA");
        MnInputHasilLabPA.setName("MnInputHasilLabPA"); // NOI18N
        MnInputHasilLabPA.setPreferredSize(new java.awt.Dimension(190, 26));
        MnInputHasilLabPA.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnInputHasilLabPAActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnInputHasilLabPA);
        ...
        label17.setText("No ID PA :");
        label17.setName("label17"); // NOI18N
        label17.setPreferredSize(new java.awt.Dimension(60, 23));
        panelisi4.add(label17);
        label17.setBounds(10, 10, 75, 23);

        Diagpa.setName("Diagpa"); // NOI18N
        Diagpa.setPreferredSize(new java.awt.Dimension(207, 23));
        Diagpa.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                DiagpaKeyPressed(evt);
            }
        });
        panelisi4.add(Diagpa);
        Diagpa.setBounds(450, 10, 226, 23);

        label12.setText("Diagnosa Klinik :");
        label12.setName("label12"); // NOI18N
        label12.setPreferredSize(new java.awt.Dimension(70, 23));
        panelisi4.add(label12);
        label12.setBounds(350, 10, 90, 23);

        Idpa.setName("Idpa"); // NOI18N
        Idpa.setPreferredSize(new java.awt.Dimension(207, 23));
        Idpa.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                IdpaKeyPressed(evt);
            }
        });
        panelisi4.add(Idpa);
        Idpa.setBounds(100, 10, 226, 23);
        ...
        makroskopik.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(201, 206, 196)));
        makroskopik.setColumns(20);
        makroskopik.setRows(5);
        makroskopik.setName("makroskopik"); // NOI18N
        Scroll7.setViewportView(makroskopik);
        ...
        mikroskopik.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(201, 206, 196)));
        mikroskopik.setColumns(20);
        mikroskopik.setRows(5);
        mikroskopik.setName("mikroskopik"); // NOI18N
        Scroll8.setViewportView(mikroskopik);

        jPanel4.add(Scroll8);
        Scroll8.getAccessibleContext().setAccessibleDescription("");
        ...
        kesimpulan.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(201, 206, 196)));
        kesimpulan.setColumns(20);
        kesimpulan.setRows(5);
        kesimpulan.setName("kesimpulan"); // NOI18N
        Scroll9.setViewportView(kesimpulan);
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
   if(tabMode.getRowCount()!=0){
            ...
            try {
                ...
                try {
                    ...
                    while(rs.next()){
                        ...
                        kesimp="";
                        ps5=koneksi.prepareStatement(
                            "select idpa,diagnosa_klinik,makroskopik,mikroskopik,kesimpulan from baca_lab_pa where no_rawat=? and tgl_periksa=? and jam=?");
                        try {
                            ps5.setString(1,tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString());
                            ps5.setString(2,tbDokter.getValueAt(tbDokter.getSelectedRow(),3).toString());
                            ps5.setString(3,tbDokter.getValueAt(tbDokter.getSelectedRow(),4).toString());
                            rs2=ps5.executeQuery();
                            while(rs2.next()){
                                idpa=rs2.getString("idpa");
                                diagpa=rs2.getString("diagnosa_klinik");
                                makros=rs2.getString("makroskopik");
                                mikros=rs2.getString("mikroskopik");
                                kesimp=rs2.getString("kesimpulan");
                            }
                        } catch (Exception e) {
                            System.out.println("Notif : "+e);
                        } finally{
                        ...
                        param.put("idpa",idpa);
                        param.put("diagnosa_klinik",diagpa);
                        param.put("makroskopik",makros);
                        param.put("mikroskopik",mikros);
                        param.put("kesimpulan",kesimp);
                        Sequel.queryu("truncate table temporary_lab");
                        ps2=koneksi.prepareStatement(
                            "select jns_perawatan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan,periksa_lab.biaya from periksa_lab inner join jns_perawatan_lab "+
                            "on periksa_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw where periksa_lab.no_rawat=? and periksa_lab.tgl_periksa=? "+
    ...
    private void MnInputHasilLabPAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnInputHasilLabPAActionPerformed
         this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
            TCari.requestFocus();
               ...
               JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data yang mau ditampilkan...!!!!"); 
                ...
                try {
                    ...
                    try {
                        ...
                        rs=ps5.executeQuery();
                        while(rs.next()){      
                            Idpa.setText(rs.getString("idpa"));
                            Diagpa.setText(rs.getString("diagnosa_klinik"));
                            makroskopik.setText(rs.getString("makroskopik"));
                            mikroskopik.setText(rs.getString("mikroskopik"));
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnInputHasilLabPAActionPerformed

    private void BtnSimpan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan1ActionPerformed
        if(Kd2.getText().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data yang mau ditampilkan...!!!!");
        }else{
            if(Idpa.getText().equals("")&&Diagpa.getText().equals("")&&makroskopik.getText().equals("")&&mikroskopik.getText().equals("")&&kesimpulan.getText().equals("")){
                Sequel.queryu2("delete from baca_lab_pa where no_rawat=? and tgl_periksa=? and jam=?",3,new String[]{
                    tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),tbDokter.getValueAt(tbDokter.getSelectedRow(),3).toString(),tbDokter.getValueAt(tbDokter.getSelectedRow(),4).toString()
                });
            }else{
                if(Sequel.menyimpantf2("baca_lab_pa","?,?,?,?,?,?,?,?","Hasil Lab PA", 8,new String[]{
                    tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),tbDokter.getValueAt(tbDokter.getSelectedRow(),3).toString(),
                    tbDokter.getValueAt(tbDokter.getSelectedRow(),4).toString(),
                    Idpa.getText(),Diagpa.getText(),makroskopik.getText(),mikroskopik.getText(),kesimpulan.getText()
                })==false){
                    Sequel.queryu2("update baca_lab_pa set idpa=?,diagnosa_klinik=?,makroskopik=?,mikroskopik=?,kesimpulan=? where no_rawat=? and tgl_periksa=? and jam=?",8,new String[]{
                        Idpa.getText(),Diagpa.getText(),makroskopik.getText(),mikroskopik.getText(),kesimpulan.getText(),
    ...
    private void DiagpaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiagpaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_DiagpaKeyPressed

    private void IdpaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_IdpaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_IdpaKeyPressed
    ...
    */
    ...
    private widget.TextBox Diagpa;
    private widget.TextBox Idpa;
    ...
    private javax.swing.JMenuItem MnInputHasilLabPA;
    ...
    private widget.TextArea makroskopik;
    private widget.TextArea mikroskopik;
        ...
        try {
            ...
            if(NoRawat.getText().equals("")&&kdmem.getText().equals("")&&kdptg.getText().equals("")&&TCari.getText().equals("")){
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "(template_laboratorium.Pemeriksaan like ? or jns_perawatan_lab.nm_perawatan like ? or reg_periksa.no_rkm_medis like ?) "+
