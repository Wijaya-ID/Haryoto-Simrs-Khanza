...
public class DlgKamarInap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ppDataKlasifikasi = new javax.swing.JMenuItem();
        ...
        MnLabelTracker.setText("Label Pasien");
        ...
        MnLabelTracker1.setText("Tracker Pasien");
        ...
        ppDataKlasifikasi.setBackground(new java.awt.Color(255, 255, 254));
        ppDataKlasifikasi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppDataKlasifikasi.setForeground(new java.awt.Color(50, 50, 50));
        ppDataKlasifikasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppDataKlasifikasi.setText("Data Klasifikasi Pasien");
        ppDataKlasifikasi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppDataKlasifikasi.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppDataKlasifikasi.setName("ppDataKlasifikasi"); // NOI18N
        ppDataKlasifikasi.setPreferredSize(new java.awt.Dimension(200, 26));
        ppDataKlasifikasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppDataKlasifikasiBtnPrintActionPerformed(evt);
            }
        });
        MenuInputData.add(ppDataKlasifikasi);
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-09-2020" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-09-2020" }));
...
private void MnRujukMasukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRujukMasukActionPerformed
    ...
    private void ppDataKlasifikasiBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppDataKlasifikasiBtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else{
                ...
                if(tbKamIn.getValueAt(tbKamIn.getSelectedRow(),0).toString().equals("")){
                    try {
                        ...
                        try {
                            ...
                            rs2=psanak.executeQuery();
                            if(rs2.next()){
                                DlgDataKlasifikasi klasifikasi=new DlgDataKlasifikasi(null,false);
                                klasifikasi.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                                klasifikasi.setLocationRelativeTo(internalFrame1);
                                klasifikasi.emptTeks();
                                klasifikasi.isCek();
                                klasifikasi.setNoRm(rs2.getString("no_rawat2"),DTPCari1.getDate(),DTPCari2.getDate()); 
                                klasifikasi.tampil();
                                klasifikasi.setVisible(true);
                            }else{
                                JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
                                tbKamIn.requestFocus();
                            }
                    ...
                    klasifikasi.emptTeks();
                    klasifikasi.isCek();
                    klasifikasi.setNoRm(norawat.getText(),DTPCari1.getDate(),DTPCari2.getDate()); 
                    klasifikasi.tampil();
                    klasifikasi.setVisible(true);
                    //this.dispose();
                }
    ...
    }//GEN-LAST:event_ppDataKlasifikasiBtnPrintActionPerformed
