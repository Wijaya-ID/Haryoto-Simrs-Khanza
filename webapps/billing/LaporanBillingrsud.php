...
<html>
    ...
    <?php
        ...
        $reg =getOne("SELECT IF(SUM(totalbiaya)='','0',SUM(totalbiaya)) AS registasi FROM billing WHERE no_rawat='$norawat' and status='Registrasi'");
        $kam =getOne("SELECT IF(SUM(totalbiaya)='','0',SUM(totalbiaya)) AS registasi FROM billing WHERE no_rawat='$norawat' and status='Kamar'");
        ...
        if(mysqli_num_rows($hasil)!=0) { 
            ...
            <tr>
              <td colspan='7' padding='0'>
               <hr/>
                <center><font color='333333' size='1'  face='Tahoma'>Lembar Bantu</font> </center>
              </td>
            </tr>
            <tr>
              <td >
                <font color='333333' size='1'  face='Tahoma'>Karcis</font>
              </td>
              <td>:</td>
              <td><font color='333333' size='1'  face='Tahoma'>Rp.$reg</font></td>
              <td></td>
              <td></td>
              <td></td>
            </tr>
            <tr>
              <td >
                <font color='333333' size='1'  face='Tahoma'>Kamar</font>
              </td>
              <td>:</td>
              <td><font color='333333' size='1'  face='Tahoma'>Rp.$kam</font></td>
              <td></td>
              <td></td>
              <td></td>
            </tr>
